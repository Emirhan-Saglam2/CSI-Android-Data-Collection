...
public class ESP32CSISerial {
        ...
        public void onReceive(Context context, Intent intent) {
            switch (intent.getAction()) {
                ...
                case UsbService.ACTION_NO_USB: // NO USB CONNECTED
                    Toast.makeText(context, "Telefon USB cihazını algılamadı; OTG ayarını ve veri kablosunu kontrol edin", Toast.LENGTH_LONG).show();
                    break;
    ...
    private void setFilters() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            activity.registerReceiver(mUsbReceiver, filter, 4); // Context.RECEIVER_NOT_EXPORTED
        } else {
